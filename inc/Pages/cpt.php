<?php
/**
 * Template part for displaying Custom Post Type Admin Area
 *
...
<div class="wrap">
	...
	<ul class="nav nav-tabs">
		...
		<li class="<?php echo isset($_POST['edit_post']) ? 'active' : ''; ?>">
			<a href="#tab-2">
				<?php echo isset($_POST['edit_post']) ? 'Edit' : 'Add'; ?> Your Custom Post Type
			</a>
		</li>
		<li>
	...
	<div class="tab-content">
		...
		<div id="tab-2" class="tab-pane <?php echo isset($_POST['edit_post']) ? 'active' : ''; ?>">
			<form method="post" action="options.php">
				<?php 
					settings_fields('seedwps_plugin_cpt_settings');
					do_settings_sections('seedwps_cpt_manager');
					submit_button();
				?>		
			</form>
		</div>
...
function custom_post_type() {
	...
	$labels = array(
		'name'                  => _x( 'Post Types', '<?php echo $option['singular_name']; ?>', 'text_domain' ),
		...
		'add_new_item'          => __( 'Add New <?php echo $option['plural_name']; ?>', 'text_domain' ),
